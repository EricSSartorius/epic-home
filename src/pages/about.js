...
const AboutPage = ({ location }) => (
  <Layout location={location}>
    ...
    <section className="about">
      ...
      <p>Life is short and I want to see how much I can explore and learn before I die! If you are curious about how I have time to code, design, model, study languages, and workout all while traveling the world, check out my <Link to="/blog/">travel blog.</Link></p>
      ...
      <ul>
        <li className="work-item">
          ...
          <p>I have 5 years of experience with web development and design. Most of my recent projects are done in React. My specialty is making blazing fast e-commerce static sites with Gatsby and Shopify. Although I mostly do full-stack programming, I also have experience creating mockups in Sketch and Figma.</p>
        </li>
        <li className="work-item">
          <h3>Translation</h3>
